        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-4 text-xs">
          ...
          <div>
            ...
            <select
              ...
              disabled={isSubmitting}
              className="w-full text-xs rounded-xl border border-slate-200 bg-slate-50/50 px-3 py-2.5 text-slate-800 focus:bg-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition shadow-2xs font-medium"
            >
              {students.map((st) => (
            ...
            {selectedStudent && (
              <div className="mt-2 p-2.5 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-between">
          ...
          <div>
            ...
            <textarea
              ...
              disabled={isSubmitting}
              className="w-full text-xs rounded-xl border border-slate-200 bg-slate-50/50 p-3 text-slate-800 focus:bg-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition shadow-2xs resize-none"
            />
