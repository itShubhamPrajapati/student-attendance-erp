...
export const AttendanceProofModal: React.FC<AttendanceProofModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in">
      <div className="bg-white rounded-3xl border border-slate-200 shadow-2xl w-full max-w-3xl max-h-[92vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-150 print:p-0 print:border-none print:shadow-none print:max-h-none print:overflow-visible">
        ...
        <div className="p-4 sm:p-6 overflow-y-auto flex-1 print:p-0 print:overflow-visible">
          {loading ? (
            ...
            <div className="p-4 rounded-2xl bg-rose-50 border border-rose-200 text-rose-800 text-xs flex items-center justify-between">
              ...
              <Button size="sm" variant="outline" onClick={fetchProof} className="bg-white">
                Retry
              </Button>
            </div>
          ) : proof ? (
