    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <Card className="p-5 bg-white border-slate-200/80 shadow-xs space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold font-heading text-slate-900">Personal Information</h3>
              </div>
            ...
            {isEditing ? (
              ...
              <form onSubmit={handleSaveProfile} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  ...
                  <div>
                    ...
                    <Input value={profile.name} disabled className="bg-slate-50 text-xs text-slate-500 font-medium cursor-not-allowed" />
                  ...
                  <div>
                    ...
                    <Input value={profile.email} disabled className="bg-slate-50 text-xs text-slate-500 font-medium cursor-not-allowed" />
                    <span className="text-[10px] text-slate-400">Authentication email — non-editable</span>
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 text-xs">
                <div className="p-3 rounded-xl bg-slate-50 border border-slate-100/80 space-y-1">
                  ...
                  <p className="font-bold text-slate-900 font-heading text-sm">{profile.name}</p>
                </div>
                ...
                <div className="p-3 rounded-xl bg-slate-50 border border-slate-100/80 space-y-1">
                  <span className="text-[10px] font-bold uppercase text-slate-400 flex items-center gap-1">
                    <MapPin className="w-3 h-3 text-indigo-500" /> City / Address
                  </span>
                  <p className="font-medium text-slate-800">
                    {profile.address || <span className="text-slate-400 italic">Not specified</span>}
                  </p>
                </div>
              </div>
            )}
          ...
          <Card className="p-5 bg-white border-slate-200/80 shadow-xs space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold font-heading text-slate-900">Academic Registration</h3>
              </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3.5 text-xs">
              ...
              <div className="p-3 rounded-xl bg-slate-50 border border-slate-100/80 space-y-0.5">
                ...
                <p className="font-mono font-bold text-indigo-700">{profile.roll_number}</p>
              </div>

              <div className="p-3 rounded-xl bg-slate-50 border border-slate-100/80 space-y-0.5">
                <span className="text-[10px] font-bold uppercase text-slate-400">Class Batch</span>
                <p className="font-bold text-slate-800">{profile.class?.name || 'Class Assigned'}</p>
              </div>

              <div className="p-3 rounded-xl bg-slate-50 border border-slate-100/80 space-y-0.5">
                <span className="text-[10px] font-bold uppercase text-slate-400">Semester</span>
                <p className="font-semibold text-slate-800">Semester {profile.semester}</p>
              </div>

              <div className="p-3 rounded-xl bg-slate-50 border border-slate-100/80 space-y-0.5">
                <span className="text-[10px] font-bold uppercase text-slate-400">Section</span>
                <p className="font-semibold text-slate-800">Section {profile.section}</p>
              </div>

              <div className="p-3 rounded-xl bg-slate-50 border border-slate-100/80 space-y-0.5">
                <span className="text-[10px] font-bold uppercase text-slate-400">Academic Year</span>
                <p className="font-semibold text-slate-800">{profile.class?.academic_year || '2026–2027'}</p>
              </div>
            </div>
          </Card>
        </div>

        {/* Right Column (1 Col): Attendance Summary & Account Security */}
        <div className="space-y-6">
          ...
          <Card className="p-5 bg-white border-slate-200/80 shadow-xs space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold font-heading text-slate-900">Attendance Standing</h3>
              </div>
              <Badge
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              ...
              <div className="p-2.5 rounded-xl bg-amber-50/60 border border-amber-100">
                <span className="text-[10px] font-bold uppercase text-amber-700 block">Late Check-in</span>
              ...
              <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-100">
                ...
                <span className="text-lg font-bold font-mono text-slate-700">{absentCount}</span>
              </div>
              <div className="p-2.5 rounded-xl bg-indigo-50/60 border border-indigo-100">
                ...
                <span className="text-lg font-bold font-mono text-indigo-900">{totalSessions}</span>
              </div>
            </div>
          ...
          {/* Section 4: Account Credentials & Security */}
          <Card className="p-5 bg-white border-slate-200/80 shadow-xs space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
