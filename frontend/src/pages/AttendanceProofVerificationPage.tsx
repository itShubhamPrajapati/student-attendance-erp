  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
      ...
      {loading ? (
        ...
        /* VALID PROOF STATE */
        <Card className="overflow-hidden bg-white border-slate-200 shadow-lg rounded-3xl">
          ...
          <div className="p-6 sm:p-7 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                ...
                <div className="p-3 rounded-xl bg-slate-50/80 border border-slate-100 space-y-1">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-slate-800">{data.session_date}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-slate-400">Marked At:</span>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold text-slate-900">{data.status_label || data.attendance_status}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Institution Note */}
            <div className="p-3.5 rounded-2xl bg-indigo-50/50 border border-indigo-100 text-xs text-slate-600 flex items-center gap-2.5">
        ...
        <Card className="overflow-hidden bg-white border-slate-200 shadow-lg rounded-3xl">
          ...
          <div className="p-6 sm:p-7 space-y-5 text-xs text-slate-600">
            <div className="p-4 rounded-2xl bg-rose-50 border border-rose-200 text-rose-900 space-y-1">
              ...
              <span className="font-mono text-sm font-bold text-rose-700">{searchCode || '—'}</span>
            ...
            <form onSubmit={handleManualSearch} className="space-y-3 pt-2">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 text-xs rounded-xl border border-slate-200 px-3.5 py-2 font-mono text-slate-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
                />
